<template>
	<view>
		<nav-bar type="transparentFixed" title="意见反馈"  :scrollTop="scrollTop" fontColor="rgb(96, 98, 102)" transparentFixedFontColor="rgba(96, 98, 102)">
		...
		<view > 
			<mescroll-body-diy height="470px" @init="mescrollInit" :down="downOption" :up="upOption" @down="downCallback" @up="upCallback">
				...
				<u-form :model="form" ref="uForm">
						...
						<u-form-item label="内容"><u-input v-model="form.intro" type='textarea'/></u-form-item>
					</u-form>
				</view>
