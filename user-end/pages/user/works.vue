<template>
	<view>
		...
		<nav-bar   title="我的作品"  :scrollTop="scrollTop" fontColor="rgb(96, 98, 102)" transparentFixedFontColor="rgba(96, 98, 102)">
			...
			<view slot="transparentFixedRight" style="color: #000000;">
				<u-icon @tap="gopage('/pages/user/addworks')"  name="plus" :size="50" style="margin-right: 20px;"></u-icon>
			</view> 
			...
			<mescroll-body-diy height="470px" @init="mescrollInit" :down="downOption" :up="upOption" @down="downCallback" @up="upCallback"> 
					<u-swipe-action :options="options" btn-width="120" style="width:100%;padding-bottom: 40rpx;" v-for="(itme,index) in booklist" :key="index">
						<view class="u-body-item">
							...
							<!-- <u-lazy-load @click="tabinfo" class="images" height="160" :image="itme.image" threshold="300" img-mode="aspectFill"></u-lazy-load> -->
							
							<view class="images"><u-lazy-load @click="tabinfo"  :image="itme.image" threshold="300" border-radius="6"
									mode="aspectFill"></u-lazy-load></view>
							
							<view class="content">
								<view class="booktitle">
									<view @click="tabinfo">{{ itme.name }}</view>
									<view style="position: absolute;right:120rpx;margin-right: 30rpx;">
										<u-tag  @tap="gopage('/pages/user/workslist')" style="margin-right: 10rpx;padding: 10rpx 5rpx;" text="已发布章节" type="info" mode="dark" size="mini" />
										<u-tag  @tap="gopage('/pages/user/addworks')" style="margin-right: 10rpx;padding: 10rpx 5rpx;" text="编辑" type="error" mode="dark" size="mini" />
										<u-tag @tap="gopage('/pages/user/send')"   style="margin-right: 10rpx;padding: 10rpx 5rpx;" text="添加章节" mode="dark" size="mini" />
									</view>
								</view>
				...
				<view style="margin-bottom:30rpx;">
					<u-divider>您的当前共有4个作品</u-divider>
				</view>
			</mescroll-body-diy>
		</view>
	</view>
