<template>
	<view>
		<nav-bar type="transparentFixed" title="个人信息" :scrollTop="scrollTop" fontColor="rgb(96, 98, 102)"
		...
		<view>
			<view class="axin-p-3">
				<u-form :model="form" ref="uForm">
					...
					<u-form-item label="手机"><u-input v-model="form.name" /></u-form-item>
					<u-form-item label="签名"><u-input :maxlength="maxlength" :border="border" :height="height"
							:auto-height="autoHeight" v-model="form.intro" type='textarea' /></u-form-item>
			...
			<view style="margin:60rpx;">
				<u-button type="primary">更新</u-button>
			</view>
		</view>
	</view>
</template>
